          ...
          <div key={post.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="flex flex-col gap-3 md:gap-4 p-4">
              ...
              <p className="text-gray-400 text-sm md:text-base line-clamp-3">
                {post.excerpt || "امگا-۳، اسید چرب ضروری برای سلامتی قلب و مغز، یکی از مواد مغذی کلیدی است که بدن ما نمی‌تواند آن را تولید کند. ماهی‌های تازه، به‌ویژه از جنوب ایران، سرشار از این ماده هستند. اما آیا مکمل‌های امگا-۳ می‌توانند جایگزین ماهی شوند؟ در این مقاله، فواید امگا-۳ را بررسی کرده و آن را در ماهی و مکمل‌ها مقایسه می‌کنیم تا بهترین گزینه را برای شما پیدا کنیم"}
              </p>
